		...
		set
		{
			...
			if (focusObj != null)
			{
				...
				if (!Application.isEditor)
				{
					...
					iKeyboard = TouchScreenKeyboard.Open(controlText, (TouchScreenKeyboardType)kbInfo.type, kbInfo.autoCorrect, kbInfo.multiline, kbInfo.secure, kbInfo.alert, controlText);

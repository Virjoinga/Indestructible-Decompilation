...
public class SpriteText : MonoBehaviour, IUseCamera
{
	...
	private void PreAwake()
	{
		...
		if (UIManager.Exists())
		{
			...
			{
				component.sharedMaterial = UIManager.instance.defaultFontMaterial;
			}
		}
		AssetMapper instance = AssetMapper.Instance;
		font = instance.MapObjectOrDefault(font, font);
		if (component != null)
		{
			component.sharedMaterial = instance.MapObjectOrDefault(component.sharedMaterial, component.sharedMaterial);
		}
	}
	...
	{
		//Discarded unreachable code: IL_00a8, IL_00bb
		if (str.Length < 6)
		{
			return color;
		}
